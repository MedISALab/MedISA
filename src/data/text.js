export const texts = {
  banner: {
    title: "MedISA Lab",
    //title: "@IIT Jodhpur",
    description: "@IIT Jodhpur" //"<strong>The MedISA</strong>Lab<strong> at IIT Jodhpur focusses on medical image synthesis and analysis</strong> problems using advanced AI techniques for affordable healthcare."
  },
  highlights: {
